        ...
        <div class="col-md-12">
            <div class="card border-0 shadow rounded">
                <div class="card-header">
                        <Center>TAMBAH DATA KELAS 1</Center>
                    </div>
                    <div class="card-body">
                        @if ($errors->any())
                        ...
                        @endif
                        <form action="{{ route('crudekstra1.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <a class="btn btn-md btn-primary" href="{{ route('crudekstra1.index') }}" class="">KEMBALI</a>
                        </form> 
                    </div>
                </div>
            </div>
