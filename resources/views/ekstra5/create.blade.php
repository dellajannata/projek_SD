            ...
            <div class="card border-0 shadow rounded">
                <div class="card-header">
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        <form action="{{ route('crudekstra5.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <a class="btn btn-md btn-primary" href="{{ route('crudekstra5.index') }}" class="">KEMBALI</a>
                        </form> 
                    </div>
                </div>
            </div>
