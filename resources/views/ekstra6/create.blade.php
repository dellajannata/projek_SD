            ...
            <div class="card border-0 shadow rounded">
                <div class="card-header">
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        <form action="{{ route('crudekstra6.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <a class="btn btn-md btn-primary" href="{{ route('crudekstra6.index') }}" class="">KEMBALI</a>
                        </form> 
                    </div>
                </div>
            </div>
