        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-9 blog-post-single">
                    @foreach ($detailP5 as $i)
                        <div class="blog-item">
                            <div class="image-blog">
                                <img src="{{ asset('storage/projekP5/' . $i->image) }}">
                            </div>
                            <div class="meta-info-blog">
								<span><i class="fa fa-calendar"></i> <a>{{$i->tanggal}}</a> </span>
							</div>
                            <div class="post-content">
                                <div class="cblog-title">
                                    <h2 style="text-align: center;"><a title="">{{$i->namaKegiatan}}</a></h2>
                                </div>
                                <div class="blog-desc">
                                    <br>
