    ...
    <div class="container">
        <div class="row"> 
            <div class="col-lg-9 blog-post-single">
                @foreach ($detailbuletin as $bt)
                <div class="blog-item">
                    <div class="image-blog">
                        <img src="{{ asset('storage/buletin/' . $bt->gambar) }}">
                    </div>
                    <div class="post-content">
                        <div class="meta-info-blog">
                            <span><i class="fa fa-calendar"></i>{!! $bt->tanggal !!} </span>
                        </div>
                        <div class="blog-title">
                            <h2>{!! $bt->judul !!}</h2>
                        </div>
                        <div class="blog-desc">
                            <h3 class="title" style="text-align: justify">{!! $bt->deskripsi !!}</h3>
                        </div>							
                    </div>
                </div>
                @endforeach
