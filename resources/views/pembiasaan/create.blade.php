            ...
            <div class="col-md-12">
                <div class="card border-0 shadow rounded">
                    <div class="card-header">
                        <Center>TAMBAH DATA KEGIATAN</Center>
                    </div>
                    <div class="card-body">
                        @if ($errors->any())
                        ...
                        @endif
                        <form action="{{ route('pembiasaan.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('namaKegiatan') is-invalid @enderror" name="namaKegiatan" value="{{ old('namaKegiatan') }}" placeholder="Masukkan Nama Kegiatan">
