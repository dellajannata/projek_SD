        ...
        <div class="col-md-12">
            <div class="card border-0 shadow rounded">
                <div class="card-header">
                    <Center>EDIT DATA VISI & MISI</Center>
                </div>
                <div class="card-body">
                        @if ($errors->any())
                        ...
                        <form action="{{ route('visimisi.update' , $visimisi->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control @error('deskripsi') is-invalid @enderror" name="deskripsi" id="summernote" rows="5" placeholder="Masukkan Deskripsi">{{ old('deskripsi', $visimisi->deskripsi) }}</textarea>
